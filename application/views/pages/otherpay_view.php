...
<div id="hidden_div" style="display: none;">
    ...
    <div class="inner-body">
        ...
        <div style="width:50%;float:left;">
            <p>Date : <?php echo date("d-M-Y", strtotime($get_otherpay_details->LastUpdatedDateTime)); ?><br>
                Time : <?php echo date("H:i:s", strtotime($get_otherpay_details->LastUpdatedDateTime)); ?></p>
        </div>

        <div  style="width:50%;float:left;">
            <p>Table No. <?php echo $get_otherpay_details->TableNumber; ?><br>
                Bill No. <?php echo $get_otherpay_details->OrderId; ?></p>
        </div>
        ...
        <table class="table table-bordered" width="100%" cellspacing="0" style="border: none;">
            ...
            <tr>
                ...
                <td><?php echo PRICE . $get_otherpay_details->TotalPrice; ?></td>
            </tr>
            <tr>
                <th style="text-align: right;">TAX</th>
                <td><?php echo PRICE . $get_otherpay_details->TaxAmount; ?></td>
            </tr>
            <tr>
